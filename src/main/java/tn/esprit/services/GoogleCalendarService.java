...
public class GoogleCalendarService {
    ...
    private static final String TOKENS_DIRECTORY_PATH = "G:\\Bureau\\NextGenHR-Projet\\src\\main\\java\\tn\\esprit\\utils\\tokens";
    private static final List<String> SCOPES = Collections.singletonList(CalendarScopes.CALENDAR);

    // Le fichier de credentials doit se trouver dans le classpath (ex. dans src/main/resources)
    private static final String CREDENTIALS_RESOURCE = "client_secret_594149200008-e0edtqu0hj0kts3t9e14jsl8qbuba0n2.apps.googleusercontent.com.json";
