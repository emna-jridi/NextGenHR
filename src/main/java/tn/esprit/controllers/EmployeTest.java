...
public class EmployeTest implements Initializable {
    ...
    private int employeeId = 12; // Set default employee ID to 12
    private String employeeName = "Test Employee"; // Default name
    ...
    public void initialize(URL location, ResourceBundle resources) {
        // Configurer la table des tests assignés
        setupAssignedTestsTable();

        // Cacher la zone de test par défaut
        testBox.setVisible(false);

        // Initialize QuizApiService
    ...
    public void setServices(TestService dbManager, QuizApiService quizAPIService,
        ...
        // Mettre à jour le libellé de bienvenue
        welcomeLabel.setText("Bienvenue, " + this.employeeName +  ")!");

        // Charger les tests assignés à cet employé
        loadAssignedTests();
    }
    ...
    private void startTest(TestAssignment assignment) {
        try {
            ...
            // Afficher la zone de test et masquer la liste des tests
    ...
    private void finishTest() {
        try {
            ...
            if (resultId != -1) {
                // Mettre à jour le statut du test comme "COMPLETED"
