...
public class RhTest implements Initializable {
    ...
    // Initialize TestService here instead of waiting for setServices
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Configurer la table des affectations
        setupAssignmentsTable();

        // Date d'échéance par défaut (demain)
        deadlineDatePicker.setValue(LocalDate.now().plusDays(1));

        // Charger les affectations existantes directement dans initialize
        loadAssignments();
        loadEmployeeNames();
    }

    // This method can still be used if you need to update services later
    ...
    private void loadAssignments() {
        try {
            ...
            // Charger toutes les affectations pour cet administrateur
    ...
    private void handleAssignTest() {
        try {
            ...
            // Récupérer l'ID de l'employé à partir du ChoiceBox
