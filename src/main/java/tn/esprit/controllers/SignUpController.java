...
public class SignUpController {
    ...
    @FXML
    private CheckBox checkboxCandidat;
    ...
    private void handleCheckboxSelection(ActionEvent event) {
        ...
        if (source.equals(checkboxEmploye)) {
            ...
            checkboxCandidat.setSelected(false);
        } else if (source.equals(checkboxRH)) {
            checkboxEmploye.setSelected(false);
            checkboxCandidat.setSelected(false);
        } else if (source.equals(checkboxCandidat)) {
            checkboxEmploye.setSelected(false);
            checkboxRH.setSelected(false);
        }
    }
    ...
    private void handleSignUp() {
        ...
        if (!checkboxEmploye.isSelected() && !checkboxRH.isSelected() && !checkboxCandidat.isSelected()) {
        ...
        ROLE role;
        if (checkboxEmploye.isSelected()) {
            role = ROLE.Employe;
        } else if (checkboxRH.isSelected()) {
            role = ROLE.ResponsableRH;
        } else {
            role = ROLE.Candidat; // Nouveau rôle
        }
